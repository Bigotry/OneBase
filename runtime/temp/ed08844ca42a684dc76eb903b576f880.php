<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:49:"E:\test\public/../app/admin\view\index\index.html";i:1493226037;s:44:"E:\test\public/../app/admin\view\layout.html";i:1493226037;s:48:"E:\test\public/../app/admin\view\layout\top.html";i:1493226037;s:51:"E:\test\public/../app/admin\view\layout\header.html";i:1493226037;s:57:"E:\test\public/../app/admin\view\layout\sidebar_left.html";i:1493260802;s:51:"E:\test\public/../app/admin\view\layout\crumbs.html";i:1493226037;s:51:"E:\test\public/../app/admin\view\layout\footer.html";i:1493226037;s:58:"E:\test\public/../app/admin\view\layout\sidebar_right.html";i:1493226037;s:51:"E:\test\public/../app/admin\view\layout\bottom.html";i:1493226037;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="row">
  <div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-aqua">
      ...
      <a onclick="toast.error('研发中...');" class="small-box-footer">查看列表 <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <!-- ./col -->
  <div class="col-lg-3 col-xs-6">
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="row">
          ...
          <div class="col-md-4">
            <p class="text-center">
              <strong>同比上月度数据</strong>
            </p>

            <div class="progress-group">
              <span class="progress-text">文章数量</span>
            ...
            <!-- /.progress-group -->
            <div class="progress-group">
              <span class="progress-text">访问数量</span>
            ...
            <!-- /.progress-group -->
            <div class="progress-group">
              <span class="progress-text">反馈数量</span>
            ...
            <!-- /.progress-group -->
            <div class="progress-group">
              <span class="progress-text">会员数量</span>
        ...
        <div class="row">
          <div class="col-sm-3 col-xs-6">
            <div class="description-block border-right">
              ...
              <h5 class="description-header">2105450</h5>
              <span class="description-text">文章同比</span>
            </div>
            <!-- /.description-block -->
          </div>
          <!-- /.col -->
          <div class="col-sm-3 col-xs-6">
            <div class="description-block border-right">
              ...
              <h5 class="description-header">1568</h5>
              <span class="description-text">反馈同比</span>
            </div>
            <!-- /.description-block -->
          </div>
          <!-- /.col -->
          <div class="col-sm-3 col-xs-6">
            <div class="description-block border-right">
              ...
              <h5 class="description-header">15466782</h5>
              <span class="description-text">会员同比</span>
            </div>
            <!-- /.description-block -->
          </div>
          <!-- /.col -->
          <div class="col-sm-3 col-xs-6">
            <div class="description-block">
              ...
              <h5 class="description-header">12056520</h5>
              <span class="description-text">访客同比</span>
            </div>
            <!-- /.description-block -->
          </div>
        </div>
...
<script src="__STATIC__/ext/adminlte/plugins/chartjs/Chart.min.js"></script>
<script src="__STATIC__/admin/js/chart_init.js"></script>
    </section>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
