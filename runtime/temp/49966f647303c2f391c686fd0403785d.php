<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:55:"E:\test\public/../app/admin\view\member\member_mod.html";i:1493269476;s:44:"E:\test\public/../app/admin\view\layout.html";i:1493226037;s:48:"E:\test\public/../app/admin\view\layout\top.html";i:1493226037;s:51:"E:\test\public/../app/admin\view\layout\header.html";i:1493226037;s:57:"E:\test\public/../app/admin\view\layout\sidebar_left.html";i:1493260802;s:51:"E:\test\public/../app/admin\view\layout\crumbs.html";i:1493226037;s:51:"E:\test\public/../app/admin\view\layout\footer.html";i:1493226037;s:58:"E:\test\public/../app/admin\view\layout\sidebar_right.html";i:1493226037;s:51:"E:\test\public/../app/admin\view\layout\bottom.html";i:1493226037;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control" name="username" placeholder="请输入用户名" readonly value="<?php echo !empty($preson['username'])?$preson['username']:''; ?>" type="text">
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label>昵称</label>
              <span>（用户名会作为默认的昵称）</span>
              <input class="form-control" name="nickname" placeholder="请输入昵称" value="<?php echo !empty($preson['username'])?$preson['username']:''; ?>" type="text">
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label>电话</label>
              <span>（移动电话）</span>
              <input class="form-control" name="mobile" placeholder="请输入电话" value="<?php echo !empty($preson['mobile'])?$preson['mobile']:''; ?>" type="text">
              <input hidden name="id"   value="<?php echo !empty($preson['id'])?$preson['id']:''; ?>" type="text">
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control" name="password" placeholder="请输入密码(不输入则为不修改)" type="password">
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control" name="email" placeholder="请输入邮箱"  value="<?php echo !empty($preson['email'])?$preson['email']:''; ?>" type="text">
            </div>
          </div>
