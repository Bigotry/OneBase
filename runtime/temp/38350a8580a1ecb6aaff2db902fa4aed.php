...
<div class="box">
  <div class="box-header">
    ...
    <ob_link><a id="picture_clear" class="btn" url="<?php echo url('pictureClear'); ?>"><i class="fa fa-close"></i> 开始清理</a></ob_link>
...
<script type="text/javascript">
    ...
    $("#picture_clear").click(function(){ sendUrlRequest('picture_clear'); });
</script>
    </section>
    <!-- /.content -->
  </div>
