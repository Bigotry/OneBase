        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label>图标</label>
              <span>（文章分类图标）</span>
              <input class="form-control" name="icon" placeholder="请输入文章分类图标" value="<?php echo (isset($info['icon']) && ($info['icon'] !== '')?$info['icon']:''); ?>" type="text">
            </div>
          </div>
