<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"E:\Wamp\www\OneBase/application/admin\view\public\login.html";i:1469369159;}*/ ?>
<!doctype html>
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>欢迎您登录OneBase</title>
                ...
                <div class="login-main pr">
                    <form action="<?php echo url('login'); ?>" method="post" class="login-form">
                        ...
                        <div id="itemBox" class="item-box">
                            ...
                            <div>
                                <img class="verifyimg reloadverify" alt="点击切换" src="<?php echo url('AdminPublic/verify'); ?>">
                            </div>
                        </div>
