                ...
                <tr>
                  ...
                  <td class="col-md-2 text-center">
                      <?php if($vo['is_install'] == '1'): ?>
                        <a href="<?php echo url('driverInstall', array('service_class' => input('service_name'), 'driver_class' => $vo['driver_class'])); ?>" class="btn"><i class="fa fa-edit"></i> 设 置</a>
                        <a class="btn confirm ajax-get" href="<?php echo url('driverUninstall', array('service_class' => input('service_name'), 'driver_class' => $vo['driver_class'])); ?>"><i class="fa fa-remove"></i> 卸 载</a>
                        <?php else: ?>
                        <a href="<?php echo url('driverInstall', array('service_class' => input('service_name'), 'driver_class' => $vo['driver_class'])); ?>" class="btn"><i class="fa fa-refresh"></i> 安 装</a>
                      <?php endif; ?>
                  </td>
                </tr>
