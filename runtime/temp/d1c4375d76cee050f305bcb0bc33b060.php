          ...
          <div class="col-md-6">
            <div class="form-group">
                ...
                <div id='upload_show_div' style="width:120px;display: inline;">
                    <img style='max-width:100px; margin-right: 20px;' src="<?php echo get_picture_url((isset($info['cover_id']) && ($info['cover_id'] !== '')?$info['cover_id']:'0')); ?>" />
                </div>
...
<?php echo hook('ImgUpload', array('id'=> 'cover_img', 'max_number' => 1)); ?>
...
var upload_success = function( file, response) {
    ...
    var show_img_url = '/upload/picture/' + response.path;
