...
<script src="/addon/file/static/jquery.uploadify.min.js"></script>
<link rel="stylesheet" href="/addon/file/static/uploadify.css">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if(empty($info) || (($info instanceof \think\Collection || $info instanceof \think\Paginator ) && $info->isEmpty())): $cover_id_var = '0'; else: $cover_id_var = $info['cover_id']; endif; ?>
                
                <?php echo hook('File', ['name' => 'cover_id', 'value' => $cover_id_var, 'type' => 'img']); ?>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if(empty($info) || (($info instanceof \think\Collection || $info instanceof \think\Paginator ) && $info->isEmpty())): $img_ids_var = ''; else: $img_ids_var = $info['img_ids']; endif; ?>
                
                <?php echo hook('Imgs', ['name' => 'img_ids', 'value' => $img_ids_var]); ?>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if(empty($info) || (($info instanceof \think\Collection || $info instanceof \think\Paginator ) && $info->isEmpty())): $file_id_var = '0'; else: $file_id_var = $info['file_id']; endif; ?>
                
                <?php echo hook('File', ['name' => 'file_id', 'value' => $file_id_var, 'type' => 'file']); ?>
            </div>
          </div>
