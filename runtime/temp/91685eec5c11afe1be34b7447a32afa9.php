<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:52:"E:\test\public/../app/admin\view\menu\menu_list.html";i:1493226037;s:44:"E:\test\public/../app/admin\view\layout.html";i:1493226037;s:48:"E:\test\public/../app/admin\view\layout\top.html";i:1493226037;s:51:"E:\test\public/../app/admin\view\layout\header.html";i:1493226037;s:57:"E:\test\public/../app/admin\view\layout\sidebar_left.html";i:1493260802;s:51:"E:\test\public/../app/admin\view\layout\crumbs.html";i:1493226037;s:51:"E:\test\public/../app/admin\view\layout\footer.html";i:1493226037;s:58:"E:\test\public/../app/admin\view\layout\sidebar_right.html";i:1493226037;s:51:"E:\test\public/../app/admin\view\layout\bottom.html";i:1493226037;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="box">
  <div class="box-header">
      <a class="btn" href="<?php echo url('menuAdd',array('pid' => $pid)); ?>"><i class="fa fa-plus"></i> 新 增</a>
<!--      <div class="box-tools">
        <div class="input-group input-group-sm table-search">
          <input name="table_search" class="form-control pull-right" placeholder="请输入搜索信息" type="text">
      ...
      <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): ?>
        <tbody>
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                  <td>
                      <a class="btn-frameless" href="<?php echo url('menuList', array('pid' => $vo['id'])); ?>"><?php echo $vo['name']; ?></a>
                  </td>
                  ...
                  <td>
                      ...
                      &nbsp;
                      <a href="<?php echo url('menuEdit', array('id' => $vo['id'])); ?>" class="btn"><i class="fa fa-edit"></i> 编 辑</a>
                      &nbsp;
                      <a class="btn confirm ajax-get"  href="<?php echo url('menuDel', array('id' => $vo['id'])); ?>"><i class="fa fa-trash-o"></i> 删 除</a>
                  </td>
                </tr>
