<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:58:"E:\test\public/../app/admin\view\article\article_list.html";i:1493226037;s:44:"E:\test\public/../app/admin\view\layout.html";i:1493226037;s:48:"E:\test\public/../app/admin\view\layout\top.html";i:1493226037;s:51:"E:\test\public/../app/admin\view\layout\header.html";i:1493226037;s:57:"E:\test\public/../app/admin\view\layout\sidebar_left.html";i:1493226037;s:51:"E:\test\public/../app/admin\view\layout\crumbs.html";i:1493226037;s:51:"E:\test\public/../app/admin\view\layout\footer.html";i:1493226037;s:58:"E:\test\public/../app/admin\view\layout\sidebar_right.html";i:1493226037;s:51:"E:\test\public/../app/admin\view\layout\bottom.html";i:1493226037;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="box">
  <div class="box-header">
    <a class="btn " href="<?php echo url('articleAdd'); ?>"><i class="fa fa-plus"></i> 新 增</a>
  </div>
  <div class="box-body">
        ...
        <tbody>
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                  ...
                  <td>
                    <?php if(!(empty($vo['cover_path']) || (($vo['cover_path'] instanceof \think\Collection || $vo['cover_path'] instanceof \think\Paginator ) && $vo['cover_path']->isEmpty()))): ?>
                        <img class="admin-list-img-size" src="<?php echo $vo['cover_path']; ?>"/>
                    <?php endif; ?>
                  </td>
                  <td><?php echo $vo['nickname']; ?></td>
                  <td><?php echo $vo['create_time']; ?></td>
                  <td>
                      <a href="<?php echo url('articleEdit', array('id' => $vo['id'])); ?>" class="btn "><i class="fa fa-edit"></i> 编辑</a>
                      <a class="btn  confirm ajax-get"  href="<?php echo url('articleDel', array('id' => $vo['id'])); ?>"><i class="fa fa-trash-o"></i> 删除</a>
                  </td>
                </tr>
