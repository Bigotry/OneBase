<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"E:\Wamp\www\OneBase\public/../app/admin\view\login\login.html";i:1491244785;s:60:"E:\Wamp\www\OneBase\public/../app/admin\view\layout\top.html";i:1491289433;s:63:"E:\Wamp\www\OneBase\public/../app/admin\view\layout\bottom.html";i:1491289456;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <link rel="stylesheet" href="__STATIC__/ext/adminlte/dist/css/skins/_all-skins.min.css">
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo url('loginHandle'); ?>" method="post" class="admin-login-form">
      <div class="form-group has-feedback">
           <input type="text" name="username" value="admin" class="form-control" placeholder="请输入您的用户名">
           <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
           <input type="password" name="password" value="admin" class="form-control" placeholder="请输入您的密码">
      ...
      <div class="row">
        <div class="col-xs-8">
          <input type="text" name="verify" class="form-control" placeholder="请输入您的验证码">
...
<script>
    var logout_url = "<?php echo url('Login/logout'); ?>";
</script>
