        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label>名称</label>
              <span>（SEO名称便于查阅）</span>
              <input class="form-control" name="name" placeholder="请输入SEO名称" value="<?php echo (isset($info['name']) && ($info['name'] !== '')?$info['name']:''); ?>" type="text">
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label>URL</label>
              <span>（格式：模块/控制器/方法 如 index/home/test 统一小写）</span>
              <input class="form-control" name="url" placeholder="请输入URL" value="<?php echo (isset($info['url']) && ($info['url'] !== '')?$info['url']:''); ?>" type="text">
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
                <label>SEO标题</label>
                <span>（支持变量）</span>
                <textarea class="form-control" name="seo_title" rows="3" placeholder="请输入SEO标题"><?php echo (isset($info['seo_title']) && ($info['seo_title'] !== '')?$info['seo_title']:''); ?></textarea>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
                <label>SEO关键字</label>
                <span>（支持变量）</span>
                <textarea class="form-control" name="seo_keywords" rows="3" placeholder="请输入SEO关键字"><?php echo (isset($info['seo_keywords']) && ($info['seo_keywords'] !== '')?$info['seo_keywords']:''); ?></textarea>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
                <label>SEO描述</label>
                <span>（支持变量）</span>
                <textarea class="form-control" name="seo_description" rows="3" placeholder="请输入SEO描述"><?php echo (isset($info['seo_description']) && ($info['seo_description'] !== '')?$info['seo_description']:''); ?></textarea>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
                <label>可用变量</label>
                <span>（此URL中支持的可用变量）</span>
                <textarea class="form-control" name="usable_val" rows="3" placeholder="请输入可用变量"><?php echo (isset($info['usable_val']) && ($info['usable_val'] !== '')?$info['usable_val']:''); ?></textarea>
            </div>
          </div>
