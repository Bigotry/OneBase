...
OneBase是一款免费开源，快速、简单的面向对象应用研发架构，是为了快速研发应用而诞生。在保持出色的性能和新颖设计思想同时也注重易用性。遵循Apache2开源许可协议发布，意味着您可以把基于OneBase研发的应用开源或商业产品发布/销售。
...
严谨： 异常严谨的错误检测和安全机制，详细的日志信息，为您的产品保驾护航。
