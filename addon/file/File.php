...
class File extends AddonBase implements AddonInterface
{
    ...
    public function addonInfo()
    {
        ...
        return ['name' => 'File', 'title' => '文件上传', 'describe' => '文件上传插件', 'author' => 'Bigotry', 'version' => '1.0'];
    }
    ...
    public function addonConfig($param)
    {
        ...
        $addons_config['allow_postfix'] = $param['type'] == 'img' ?  '*.jpg; *.png; *.gif;' : '*.jpg; *.png; *.gif; *.zip; *.rar; *.tar; *.gz; *.7z; *.doc; *.docx; *.txt; *.xml; *.xlsx; *.xls;';
